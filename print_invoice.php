...
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><b>Phone:</b> <?php echo $bsiCore->config['conf_portal_phone'];?></span><br />
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><b>Fax:</b> <?php echo $bsiCore->config['conf_portal_fax'];?></span><br />
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><b>Email:</b> <?php echo $bsiCore->config['conf_portal_email'];?></span><br />
</td></tr>
</table><br />
