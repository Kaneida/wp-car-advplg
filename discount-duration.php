...
if(isset($_GET['delid'])){
	$bsiAdminMain->discountDelete(mysql_real_escape_string($_GET['delid'])); 
	header("location:admin.php?page=car-discount");
...
?>
 ...
 <div id="container-inside" style="width:1000px;">
        <span style="font-size:16px; font-weight:bold">Discount Upon Duration </span>&nbsp;&nbsp;
    <input type="button" value="Add New Discount Schema" onClick="window.location.href='admin.php?page=car-adddiscount&disco_id=0'" style="background: #EFEFEF; float:right"/>
  ...
  <table class="display datatable" border="0">
    <thead>
      <tr>
        <th>Booking From</th>
        <th>Booking To</th>
        <th>Discount (%) Of Total Amount</th>
        <th>&nbsp;</th>
      </tr>
    </thead>
